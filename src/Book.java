public class Book {
    ...
    public static boolean isTitleWord(String word) {
        ...
        if (word.equals("a") || word.equals("an") || word.equals("the") || word.equals("and") || word.equals("but") || word.equals("for") || word.equals("nor") || word.equals("or") || word.equals("so") || word.equals("yet") || word.equals("at") || word.equals("by") || word.equals("in") || word.equals("into") || word.equals("near") || word.equals("of") || word.equals("on") || word.equals("to")) {
            return false;
        } else {
            return true;
        }
    ...
    public void setTitle(String title) {
        ...
        if (title.isEmpty()) {
            ...
            if (!title.trim().contains(" ")) {
                ...
                for (String each : arr) {
                    if (!isTitleWord(each)) {
                        capitalizedTitle += each;
                    } else {
                        capitalizedTitle += capitalize(each);
                    }
                }
                this.title = capitalizedTitle;
            }
    ...
    public String toString() {
        ...
        return "author=" + author + " title=" + title + " id=" + 10 + " pages=" + 300;
    }
