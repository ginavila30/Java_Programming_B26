...
public class PandemicChecker {
    public static void main(String[] args) {
        ...
        if(year>=1346&&year<=1353){
            ...
            pandemic="Grate Plague of London";
      ...
      //*  pandemic=(year>=1346&&year<=1353)?"The Black Death":(year>=1665&&year<=1666)?"Grate Plague of London":"Invalid";
        // System.out.println(pandemic);// Example of Ternary
}}
