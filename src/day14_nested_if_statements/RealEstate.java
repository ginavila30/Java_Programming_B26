    ...
    public static void main(String[] args) {
        ...
        if (budget > 0 && budget < 300_000) {
            ...
            if (budget >= 55_000 && budget <= 75_000) {
                ...
                isAvailable=false;// reassigned so that when I print my add I don't get the default values of the variable.
            }
           if(isAvailable){ String ad="Name of the neighborhood: "+name+"\nThe budget range: "+range+"\nThe rating is: "+rating;

            ad+="\nGated: "+(gated?"Yes":"No"); // If the gated boolean is true it concatenate yes to the ad but if the boolean is false it wil concatenate no
            ad+="\n"+(allowPets?"They allow pets":"They don't allow pets"); //This last if is to print the ad only when is available is true. SO all my variables will get their corresponding values based on the budget range.
