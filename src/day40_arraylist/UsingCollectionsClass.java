...
//Collections methods that are useful to work with Array List
        Collections.sort(list);// sort method. Argument is collection types
        System.out.println(list);
        Collections.reverse(list);//reverse method. Argument is collection types
